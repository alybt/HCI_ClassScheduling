            ...
            if (floor === '1') {
                rooms.innerHTML = `
                    ...
                    <li class="room-item occupied" data-room="lab2">
                        ...
                        <span>Lab 2</span>
                        <span class="room-info">CC 101 until 3:00 PM</span>
                    </li>
            ...
            if (floor === '2') {
                rooms.innerHTML = `
                    ...
                    <li class="room-item occupied" data-room="lr4">
                        <div class="room-status occupied"></div>
                        <span>LR 4</span>
                        <span class="room-info">CS 201 until 1:00 PM</span>
                    </li>
                `;
            } else {
                // First floor is not accessible
                rooms.innerHTML = `
                    <li class="room-item maintenance">
                        <div class="room-status maintenance"></div>
                        <span>No Accessible Rooms</span>
                        <span class="room-info">This floor is not accessible to CCS students</span>
                    </li>
                `;
            }
        }
